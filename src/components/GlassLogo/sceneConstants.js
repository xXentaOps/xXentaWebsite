...
// Brighter grid backdrop once DRP_2 and AI Impact Analysis panel are revealed (refined desaturated warm tone)
export const SCENE_BACKDROP_DRP_BRIGHT = '#DAD8D6'
